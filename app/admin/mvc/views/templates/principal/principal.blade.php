...
<head>
  ...
  <link rel="stylesheet" href="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <link rel="stylesheet" href="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/dist/css/AdminLTE.min.css">
  <link rel="stylesheet" href="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/dist/css/skins/_all-skins.min.css">
  <link rel="stylesheet" href="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/bootstrap/css/custom.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{asset('admin/inicio')}}" class="logo">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- itens menu -->
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li>
                  ...
                  <ul class="treeview-menu">
                    <li><a href="{{asset('admin/usuarios')}}"><i class="glyphicon glyphicon-user"></i> <span>Usuários</span></a></li>
                    <li><a href="{{asset('admin/usuarios/funcoes')}}"><i class="glyphicon glyphicon-road"></i> <span>Funções</span></a></li>
                  </ul>
              </li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
                    <li><a href="{{asset('admin/relatorios/customizados')}}"><i class="glyphicon glyphicon-equalizer"></i> <span>Customizados</span></a></li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
                    <li><a href="{{asset('admin/configuracoes/parametros')}}"><i class="glyphicon glyphicon-wrench"></i> <span>Parametros de sistema</span></a></li>
            </ul>
          </li> 
          @endif
...
<script src="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/bootstrap/js/bootstrap.min.js"></script>
<!-- SlimScroll -->
<script src="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/dist/js/app.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{PASTA_PUBLIC}}/{{APP_DIR}}/template/dist/js/demo.js"></script>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{asset('admin/usuarios/sair')}}" class="btn btn-danger" >Sim</a>
        </div>
      </div>
