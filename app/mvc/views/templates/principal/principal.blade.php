        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{PASTA_PUBLIC.'/template/img/'.Auth('foto')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">{{limitarTexto(Auth('usuario'),20)}}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{PASTA_PUBLIC.'/template/img/'.Auth('foto')}}" class="img-circle" alt="User Image">
