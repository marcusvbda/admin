      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div id="loading-div" style="width:100%;" class="centro">
            <img src="<?php echo e(PASTA_PUBLIC); ?>/<?php echo e(APP_DIR); ?>/template/img/loading.gif">
          </div>
...
function limparcampos()
{
  ...
  $('#desc_tipo_pessoa_alt').html('Pessoa Física');
  $('#desc_cpf_cnpj_atl').html('CPF');
  $('#alt_foto_prof').attr('src','<?php echo e(PASTA_PUBLIC); ?>/<?php echo e(APP_DIR); ?>/uploads/fotos_profile/user.png');
}
