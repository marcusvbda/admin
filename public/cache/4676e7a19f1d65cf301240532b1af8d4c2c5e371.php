<?php $__env->startSection('titulo','Tipos Produtos'); ?>
...
<ol class="breadcrumb">
  ...
  <li><a href="<?php echo e(asset('admin/produtos/tipos')); ?>"><i class="glyphicon glyphicon-erase"></i> Tipos Produtos</a></li>
</ol>
  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        ...
        <div class="row">
          <form method="GET" action="<?php echo e(asset('produtos/tipos')); ?>">
            <div class="col-md-12">
          ...
          <div class="box-body table-responsive no-padding">  
            <div class="col-md-12">
               ...
               <tbody>
                  ...
                  <tr>
                    <td><?php echo e($tipo->numero); ?></td>
                    <td><?php echo e($tipo->descricao); ?></td>
                    <td class="centro">
                      <?php if($tipo->entradas=='S'): ?>
