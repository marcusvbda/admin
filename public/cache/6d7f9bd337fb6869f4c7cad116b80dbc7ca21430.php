<?php $__env->startSection('titulo','ERRO'); ?>
	...
	<div class="box">
        ...
        <div class="error-page">
          ...
          <div class="error-content">
            ...
            <p>
              Para acessar o endereço solicitado é obrigatório uma autenticação de administrador, tente novamente com um usuário com esta caracteristica.
            </p>
