<?php $__env->startSection('titulo','frente de caixa'); ?>
		  ...
		  <!-- conteudo -->
			...
			<div id="div_cupom_fechado" class="col-md-4" >
		  		<div class="content">
		  			...
		  			<p><strong>Usuário : </strong><?php echo e(Auth('usuario')); ?></p>
		  			<p><strong>Email : </strong><?php echo e(Auth('email')); ?></p>
		  			<hr>
...
<script type="text/javascript">
	...
	function buscar_produto(produto)
	{
		...
		$.getJSON("<?php echo e(asset('caixas/Produto')); ?>/"+produto, function(data) 
		{
