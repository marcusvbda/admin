    ...
    <div class="box box-primary">
      ...
      <!-- /.box-header -->
        <div class="box-body">
          ...
          <form id="frm_notificacoes">
            <div class="row">
              <div class="col-md-6">
                <div class="input-group input-group-sm"> 
                    <span class="input-group-addon">Estoque Baixo</span> 
                    <input type="number" step="1"  class="form-control" name="estoque_baixo" id="estoque_baixo" value="{{$config->estoque_baixo}}" disabled="" required=""> 
                </div>
              </div>              
            </div>            
          ...
          <div>
            <button type="button" class="btn btn-primary btn-sm" id="btn_editar_notificacoes" onclick="editar_notificacoes()">Editar</button>
            <div id="btn_salvar_notificacoes" style="display: none;">
              <button type="button" class="btn  btn-success btn-sm" onclick="salvar_notificacoes()">Salvar</button>
              <button type="button" class="btn btn-danger btn-sm" onclick="cancelar_notificacoes()">Cancelar</button>
            </div>
          </div>  
          @endif
        </div>
