...
<body>
    ...
    <header>
      <div class="container">
        <div class="row">
          <div class="col-xs-6">
            <a href="index.html"><img src="{{asset('public/custom/img')}}/{{env('favicon')}}" alt="Logo" width="50%"></a>
          </div>
      ...
      <div class="container">
        ...
        <div class="row margin-30 news-container">
          <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 wow fadeInLeft" data-wow-delay="0.8s">
            ...
            <img class="news-img pull-left" src="{{asset('public/landing/img/press-01.jpg')}}" alt="Tech Crunch">
